"""Composed PyO3 protocol surfaces for the deterministic policy engine."""
...
class CycleEngineProtocol(Protocol):
...
class CancelPolicyEngineProtocol(Protocol):
...
class RetryPolicyEngineProtocol(Protocol):
...
class DeterministicPolicyEngineProtocol(
    CycleEngineProtocol,
    CancelPolicyEngineProtocol,
    NotificationEngineProtocol,
    Protocol,
...
class PolicyEngineProtocol(
    ...
    """Full in-process deterministic policy engine (cycle, coin-ops, offer, retry)."""
