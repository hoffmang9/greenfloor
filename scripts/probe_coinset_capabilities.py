...
from greenfloor_scripts.coinset_subprocess import coin_records_cli, record_from_cli
...
def main() -> int:
    ...
    puzzle_all_ok, puzzle_all_err, puzzle_all_count = _supports_call(
        lambda: coin_records_cli(
            ...
            {"puzzle_hashes": [p2_coinset_hex], "include_spent_coins": True},
        )
    )
    ...
    hints_all_ok, hints_all_err, hints_all_count = _supports_call(
        lambda: coin_records_cli(
            ...
            {"hints": [p2_coinset_hex], "include_spent_coins": True},
        )
    )
