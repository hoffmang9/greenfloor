...
use super::items::{
    execute_managed_coin_op_plan, executed_item, executed_item_for_plan, plan_skip,
...
pub(crate) async fn execute_managed_split_plan(
    ...
    execute_managed_coin_op_plan(execute_managed_split_plan_inner(ctx, plan)).await
}
