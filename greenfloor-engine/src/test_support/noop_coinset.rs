...
/// Test backend that answers only [`OfferCoinsetBackend::offer_input_coin_is_spent`].
pub(crate) struct SpentFlagCoinset {
    pub spent: bool,
}

impl OfferCoinsetBackend for SpentFlagCoinset {
    async fn select_cats_for_spend(
        &self,
        _receive_address: &str,
        _asset_id: Bytes32,
