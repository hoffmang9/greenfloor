...
//! | [`SignerDenominationTestOverrides`](crate::offer::operator::SignerDenominationTestOverrides) | bootstrap | `BootstrapShapeContext.test_overrides` | `run_signer_denomination_phase_with_test_overrides` |
