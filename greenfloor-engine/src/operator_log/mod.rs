...
pub use emit::{
    audit_and_trace, audit_daemon_cycle, audit_market_cycle, trace_audit_outcome, LogContext,
};
...
pub use events::{
    ...
    DEXIE_OFFERS_ERROR, INVENTORY_BUCKET_SCAN, INVENTORY_BUCKET_SCAN_ERROR, MARKET_CYCLE_COMPLETED,
    MARKET_CYCLE_STARTED, MARKET_PHASE, MARKET_VALIDATION_WARNING, MEMPOOL_OBSERVED,
    OFFER_CANCEL_POLICY, OFFER_LIFECYCLE_TRANSITION, OFFER_PARALLEL_FALLBACK, OFFER_POST_COMPLETED,
    OFFER_POST_FAILURE, OFFER_POST_ITERATION, OFFER_RECONCILIATION, PARALLEL_OFFER_DISPATCH,
